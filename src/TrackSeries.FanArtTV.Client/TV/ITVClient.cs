...
namespace TrackSeries.FanArtTV.Client.TV
{
    ...
    {
        Task<ShowImages> GetShowAsync(int showId, CancellationToken cancellationToken);
        ...
        /// <returns></returns>
        Task<List<ShowImagesInfo>> GetLatestShowsAsync(DateTime since, CancellationToken cancellationToken);
        /// <summary>
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<List<ShowImagesInfo>> GetLatestShowsAsync(long since, CancellationToken cancellationToken);
    }
}
